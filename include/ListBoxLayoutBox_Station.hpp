...
#ifndef _EVEINDUSTRY_WX_ILISTCTRLLAYOUTSTATION_HPP_
#define _EVEINDUSTRY_WX_ILISTCTRLLAYOUTSTATION_HPP_
...
namespace EVE::Industry
{
	...
	class ListLayoutBoxStationRecord : public IListCtrlLayout
	{
	public:
		ListLayoutBoxStationRecord(wxWindow* mainForm);
...
#endif // _EVEINDUSTRY_WX_ILISTCTRLLAYOUTSTATION_HPP_
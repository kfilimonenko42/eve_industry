...
#ifndef _EVEINDUSTRY_WX_ILISTCTRLLAYOUTREGION_HPP_
#define _EVEINDUSTRY_WX_ILISTCTRLLAYOUTREGION_HPP_
...
namespace EVE::Industry
{
	...
	class ListLayoutBoxRegionRecord : public IListCtrlLayout
	{
	public:
		ListLayoutBoxRegionRecord(wxWindow* mainForm);
...
#endif // _EVEINDUSTRY_WX_ILISTCTRLLAYOUTREGION_HPP_
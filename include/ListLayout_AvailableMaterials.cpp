...
void EVE::Industry::ListLayoutAvailableMaterials::createColumns(wxListCtrl* list)
{
...
wxItemAttr* EVE::Industry::ListLayoutAvailableMaterials::getItemColumnAttr(void* container, const long index, const long column)
{
	return nullptr;
}
...
void EVE::Industry::ListLayoutAvailableMaterials::activateListItem(void* container, const long index, wxWindow* parent)
{
	const auto& list = *reinterpret_cast<std::vector<MaterialProject>*>(container);
	const auto& item = list[index];

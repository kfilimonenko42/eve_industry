...
#ifndef _EVEINDUSTRY_WX_ILISTCTRLLAYOUTTYPE_HPP_
#define _EVEINDUSTRY_WX_ILISTCTRLLAYOUTTYPE_HPP_
...
namespace EVE::Industry
{
	...
	class ListLayoutBoxTypeRecord : public IListCtrlLayout
	{
	public:
		ListLayoutBoxTypeRecord(wxWindow* mainForm);
...
#endif // _EVEINDUSTRY_WX_ILISTCTRLLAYOUTTYPE_HPP_
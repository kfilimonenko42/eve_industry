...
#ifndef _EVEINDUSTRY_WX_ILISTCTRLLAYOUTSOLARSYSTEM_HPP_
#define _EVEINDUSTRY_WX_ILISTCTRLLAYOUTSOLARSYSTEM_HPP_
...
namespace EVE::Industry
{
	...
	class ListLayoutBoxSolarSystemRecord : public IListCtrlLayout
	{
	public:
		ListLayoutBoxSolarSystemRecord(wxWindow* mainForm);
...
#endif // _EVEINDUSTRY_WX_ILISTCTRLLAYOUTSOLARSYSTEM_HPP_
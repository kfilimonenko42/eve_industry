...
{
	wxStaticText* lblRegionName = new wxStaticText(this, wxID_ANY, "Region: ", wxDefaultPosition, wxSize(50, 19));
	m_RegionName = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(220, 24), wxTE_READONLY);

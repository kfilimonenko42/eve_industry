...
wxString EVE::Industry::ListLayoutMaterialsProject::getItemText(int owner_id, void* container, const long index, const long column)
{
...
wxItemAttr* EVE::Industry::ListLayoutMaterialsProject::getGetItemColumnAttr(void* container, const long index, const long column)
{
	return nullptr;
}
